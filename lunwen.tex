...
As shown in Fig~\ref{fig:shift}, our model has achieved the best results in detecting shift points. For the six incidents we selected, PSEM achieves an average of $86\%$ of precision and $90\%$ of recall rate. In contrast, the average precision and recall of FB-LDA are $81\%$ and $73\%$. For LDA \& KL-divergence are $76\%$ and $68\%$ respectively. POMS performs the worst which average precision and recall  $52\%$ and $59\%$. %improvements in percentage: PSEM improves xxx by $xx\%$
...
\caption{Changes of $\alpha$ in six incidents}\label{fig:alpha}
\end{figure}
\vspace{-0.8cm}
