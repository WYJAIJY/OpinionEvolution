...
%Motivation
Nowadays Microblogging has become the major platform for people to publish information and share opinions about social incidents. Public opinion on Microblogging platforms has greatly influenced the society, changed the investigation and judicial outcome of social incidents~\cite{{Cheung2014Battle}}. 
...
The power of public opinion in Microblogging space makes it appealing to analyze sentiment evolution for social incidents in microblogs for individuals, enterprises, researchers, government officials and so on.
...
\begin{center}
    \centering
    \includegraphics[width=1.0\textwidth,height=3.0in]{newintro.eps}
  ...
  \node[latent, below = of b](gamma){$\gamma$};
   ...
   \node[latent, right = of alphadots](alphat){$\alpha_t$};
	...
	\edge{alphat}{alphatp};
  	...
  	\node[latent, below = 0.8 of gamma] (s0) {$s_{0}$};
       	\edge{gamma}{s0};
	...
	\edge{alphat}{yt};
	 ...
	 \plate[inner sep=0.1cm, xshift=-0cm, yshift=0 cm] {O0} {(y0)} {$M_0$};
        ...
        \node[latent, below =  of y0 ] (beta) {$\beta$};
        
       	\edge{beta}{y0};
	\edge{beta}{yt};
	   \node[latent, below = 0.8 of beta](c){$c$};
...
\begin{figure}
\centering
\subfigure[Positive Sentiment]{\label{fig:precision}
    \centering
    \includegraphics[width =.4\textwidth]{sigma_positive.eps}
}
\hspace{-4ex}
\subfigure[Negative Sentiment]{\label{fig:recall}
    \centering
...
\begin{figure}
\centering
\subfigure[Precision]{\label{fig:boxprecision}
    \centering
    \includegraphics[width =.4\textwidth]{boxPrecision.eps}
}
\hspace{-4ex}
\subfigure[Recall]{\label{fig:boxrecall}
    \centering
    \includegraphics[width =.4\textwidth]{boxRecall.eps}
}
\setlength{\abovecaptionskip}{-0.1cm}
...
\bibitem{JuMCNNsentimentclassification}
Hyunjun Ju et.al.
...
\bibitem{LaiRCNNsentimentclassification}
Siwei Lai et.al.
